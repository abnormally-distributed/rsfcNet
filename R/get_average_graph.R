...
#' @param n The sample size. Checks the global environment for n, but can be directly assigned.
#' @return A list containing both the averaged correlation matrix and a corresponding igraph object.
#' @export
...
#'
get_average_graph = function(cormats, n=.GlobalEnv$n){
  ...
  average_graph = graph.adjacency(average_matrix, mode="undirected", weighted=T,diag = FALSE)
