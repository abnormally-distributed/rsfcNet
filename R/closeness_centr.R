...
#'
#' @description This function is a convenience wrapper for igraph's closeness function and takes as an input a list of igraph objects.
#'
...
#'
#' @description This function is a convenience wrapper for igraph's closeness function for consistency with rsfcNet's naming conventions.
