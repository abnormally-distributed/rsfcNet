...
#' @param sep the seperator to use for separating entries across columns.
#' One of "," for comma separated values, " " for space separated values, or "\t" for tab separated values. Defaults to ","
